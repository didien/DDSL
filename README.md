...
- utiliser l'IDE standalone fourni dans une des archives du dossier IDE (le plus simple si ça fonctionne)
...
Pour des raisons évidentes de "on aimerait ne pas saturer le disque en clonant ce repo", l'installation générique n'a pas été fournie, elle est donc à télécharger si l'option 3 est utilisée.  
Néanmoins, les exécutables fournis pèsent déjà assez lourd.
